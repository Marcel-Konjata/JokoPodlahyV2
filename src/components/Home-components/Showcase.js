    ...
    <section className="showcase wrapper">
      ...
      <main>
        ...
        <article className="showcase-text col-6">
          ...
          <p>
            Někdo si na zeď chce nechat pověsit vinylové desky, někdo chce na
            zeď trochu jinej Vinyl. Vinyl má užasnou vlastnost, že dokáže
            imitovat několik druhů materiálu jak na pohled tak na dotek. Už máme
            za sebou několik zakázek různých druhů (od koupelen po ateliéry),
            kde jsme použily Vinyl i na zdi (viz foto)
          </p>
        </article>
      </main>
    </section>
